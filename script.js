...
function initGlobalSearch() {
    ...
    const searchData = [
        ...
        { type: 'toolbox', title: 'CEA/CCER碳市场实时看板', desc: 'CEA/CCER实时行情·价格波动分析·历史分位数定位·跨品种价差对比·成交量结构分析', category: '碳排放工具', targetId: 'carbon-tools', icon: '📊' },
        { type: 'toolbox', title: '碳市场投资分析画像报告', desc: 'CEA/CCER全周期数据分析·价格趋势与相关性·多维度风险评估·分品种操作策略建议', category: '碳排放工具', targetId: 'carbon-tools', icon: '📋' },
    ];
